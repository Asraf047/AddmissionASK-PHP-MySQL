...
<div class="c">
  ...
  <div class="cc"><h1 class="h1text">Notice</h1></div>
...
$sql = "SELECT id, name, title, date, detail, img, heading, pdf FROM notice  WHERE catagory='notice' order by id desc";
  ...
  <div class="white2 overflow left-small"> 
    ...
    <div class="container">
             <p style="min-height: 60px;"><?php
               $string=$row["detail"];
               $string = strip_tags($string); if (strlen($string) > 390) { 
               $stringCut = substr($string, 0, 390);     
      ...
      <div class="row margin-top">
        <div class="col m8 s12">
          <p><button class="button padding-large white2 border" onclick="location.href='page28.php?id=<?php echo $row["id"];?>'"><b><span>READ MORE </span></button></b></button></p>
        </div>
