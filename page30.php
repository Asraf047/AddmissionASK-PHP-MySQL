...
<div class="c">
  ...
  <div class="cc"><h1 class="h1text" style="margin-right: -45px;">Scholarship</h1></div>
...
$sql = "SELECT id, name, title, date, detail, img, heading, pdf FROM notice WHERE catagory='scholarship' order by id desc";
